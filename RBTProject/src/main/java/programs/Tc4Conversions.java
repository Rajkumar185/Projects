...
public class Tc4Conversions {
	...
	static String ExpTitle2 = "1 dollar equal to how many rupees in india - Google Search";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (ActTitle1.equalsIgnoreCase(ExpTitle1)) {
			...
			WebElement conversion=driver.findElement(By.xpath("//*[@id=\"knowledge-currency__updatable-data-column\"]/div[1]/div[2]"));
			System.out.println(conversion.getText());
			...
			//WebElement conversion=driver.findElement(By.xpath("//*[@id='rcnt']"));
			driver.close();		
		}
		else {
