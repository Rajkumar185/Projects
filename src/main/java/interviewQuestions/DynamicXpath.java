		    ...
		    //input[@placeholder='Username'  and not(name="sample") ],
		     //input[starts-with(@name,"user")],
		      //input[contains(@placeholder,'me')],
		       ////*[@placeholder='Username']//following::input xpath for password
		        ////*[@type='submit']//preceding::input[1] xpath for password
		        //*[@type='submit']//preceding::input[2] xpath for username
		        * */
